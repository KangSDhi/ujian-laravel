            ...
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                        <li><a id="link-home" href="{{ route('get.landing')}}" class="nav-link px-2 text-secondary">Beranda</a></li>
                        <li><a id="link-about" href="{{ route('get.about')}}" class="nav-link px-2 text-white">Tentang</a></li>
                    </ul>
                </div>
            </div>
        </nav>
